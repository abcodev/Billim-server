...
//            "      <a href='http://localhost:3000/emailverify/confirm?email=" + email + "&authToken=" + authToken + "'" + "style=\"display: inline-block; background-color: #fcd34d; font-weight: bolder; color: #ffffff; font-size: 13px; padding: 10px 30px; text-decoration: none; border-radius: 20px;\">이메일 인증</a>" +
            "      <a href='http://3.34.178.46:3000/emailverify/confirm?email=" + email + "&authToken=" + authToken + "'" + "style=\"display: inline-block; background-color: #fcd34d; font-weight: bolder; color: #ffffff; font-size: 13px; padding: 10px 30px; text-decoration: none; border-radius: 20px;\">이메일 인증</a>" +
            "" +
...
//            "      <p style=\"font-size: 11px; text-align: initial; padding-left: 13px; margin: 0; color: #868e96;\">http://localhost:3000/emailverify/confirm?email=" + email + "&authToken=" + authToken + "</p>" +
            "      <p style=\"font-size: 11px; text-align: initial; padding-left: 13px; margin: 0; color: #868e96;\">http://3.34.178.46:3000/emailverify/confirm?email=" + email + "&authToken=" + authToken + "</p>" +
            "    </div>" +
            "</body>" +
            "</html>";
    ...
    public String sendTempPassword(FindPasswordRequest findPasswordRequest) {
        ...
        String emailContent =
            ...
            "        <p style=\"margin-bottom: 25px; font-size: 13px; line-height: 1.5;\">" +
            "          안녕하세요. Billim 입니다. 임시비밀번호는 변경 후 사용해 주세요.<br />" +
            "        </p>" +
            "      </div>" +
            "" +
            "      <div style=\"margin: 0 auto;\">" +
            "        <p style=\"font-family: 'NanumSquareNeoExtraBold'; margin: 0; font-size: 13px; line-height: 1.5;\">임시 비밀번호</p>" +
            "        <p style=\"font-family: 'NanumSquareNeoExtraBold'; margin : 10px 0; line-height: 1.5; display: inline-block; background-color: #4d7efc; font-weight: bolder; color: #ffffff; font-size: 13px; padding: 10px 30px; border-radius: 20px;\">" + tempPassword +
            "        </p>" +
            "" +
            "      </div>" +
            "    </div>" +
